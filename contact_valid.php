...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $message_body.="<tr><td>Contact's Products : </td><td>".$_POST['products']."</td></tr>";
        
        $message_body.="<tr><td>Contact's Message : </td><td>".$_POST['message']."</td></tr>";
        $message_body.="</table></body></html>"; 
    
       
        $mail->From = 'harshawelding9999@gmail.com';
        $mail->FromName ='harshawelding9999@gmail.com'; 
		$mail->addAddress('harshawelding9999@gmail.com'); 
       
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Harsha Group';
        $mail->isHTML(true);
